...
export const EMPLOYEE_PORTAL_FEATURES = [
  ...
  { id: "chat", label: "Group Chat", description: "Company-wide employee group chat for quick internal updates." },
...
export const DEFAULT_ROLE_FEATURE_ACCESS: Record<(typeof EMPLOYEE_ROLES)[number], EmployeePortalFeature[]> = {
  ...
  sales: ["dashboard", "crm", "ops", "expenses", "documents", "announcements", "meetings", "resources", "chat"],
  content: ["dashboard", "crm", "ops", "expenses", "documents", "announcements", "meetings", "resources", "chat"],
  hr: ["dashboard", "applicants", "ops", "expenses", "payroll", "reviews", "documents", "announcements", "meetings", "resources", "employees", "chat"],
  operations: ["dashboard", "ops", "expenses", "documents", "announcements", "meetings", "resources", "chat"],
  employee: ["dashboard", "ops", "expenses", "documents", "announcements", "meetings", "resources", "chat"],
};
